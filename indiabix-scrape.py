...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Scrapes a sub directory of http://www.indiabix.com for multiple choice questions')
    ...
    for question in soup.find_all('td', {'class': 'bix-td-qtxt'}):
        ...
        result['answer'] = get_answer(
            question.parent.parent.parent.parent.find_all('b', {'class': 'jq-hdnakqb'})[0].get_text())
